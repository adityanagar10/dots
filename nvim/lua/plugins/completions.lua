  ...
  },
  {
    ...
    opts = {
      keymap = {
        ...
        -- Only accept on Enter if an item was explicitly selected (e.g. via
        -- Tab); otherwise fall through to a normal newline. Without this,
        -- blink's auto-preselected first item gets accepted on every Enter
        -- press, even when you just wanted to move to a new line.
        ["<CR>"] = { "accept", "fallback" },
        ["<C-e>"] = { "hide", "fallback" },
      },
      appearance = {
